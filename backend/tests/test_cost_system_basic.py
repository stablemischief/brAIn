...
from src.cost.cost_calculator import (
    CostCalculator, CostBreakdown, BudgetConfig, BudgetAlert, 
    BudgetPeriod, CostCategory, CostForecast
)
...
class TestTokenCounter:
    ...
    def test_estimate_tokens(self, token_counter):
        ...
        text = "This is a longer test sentence that will be used to estimate token count."
...
class TestBudgetManager:
    ...
    def test_budget_enforcement(self, budget_manager):
        ...
        budget_manager.set_budget(BudgetPeriod.DAILY, Decimal("10.0"))
        budget_manager.enable_enforcement(
            enforcement_type=BudgetEnforcement.HARD_STOP
        )
